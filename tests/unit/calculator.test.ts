...
describe("Calculator Unit Tests", () => {
  ...
  describe("Single material calculations", () => {
    it("should calculate correctly for 100kg of paper", () => {
      ...
      expect(result.ghgReduction_tCO2e.sources[0].value).toBeCloseTo(0.0292, 4);
    ...
    it("should calculate correctly for 20kg of plastic", () => {
      ...
      expect(result.ghgReduction_tCO2e.sources[2].value).toBeCloseTo(0.03, 2);
  ...
  describe("Multiple material calculations", () => {
    it("should calculate correctly for mixed materials", () => {
      ...
      expect(result.ghgReduction_tCO2e.sources[0].value).toBeCloseTo(0.0292, 4); // Paper
      expect(result.ghgReduction_tCO2e.sources[1].value).toBeCloseTo(
        0.45915,
        5
      ); // Aluminum
      expect(result.ghgReduction_tCO2e.sources[2].value).toBeCloseTo(0.03, 2); // Plastic
